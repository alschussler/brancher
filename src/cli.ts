...
const ARGS_OPTIONS = {
  ...
  branches: {
    ...
    multiple: true,
    description:
      "Target branches (repeat for each). In --pr mode: base for new backport PRs. In --cherry-pick mode: branches that will receive the cherry-pick.",
  },
  push: {
    type: "boolean" as const,
    default: false,
    description:
      "Push each branch to origin after cherry-picking (--cherry-pick mode)",
  },
  "dry-run": {
    type: "boolean" as const,
    default: false,
  ...
  pick: {
    ...
    default: false,
    description:
      "Interactively select which commits to cherry-pick (--pr mode)",
  },
  help: {
    type: "boolean" as const,
    short: "h",
...
export function printUsage(): void {
  console.log("");
  console.log(
    "brancher — Create backport PRs or cherry-pick commits across branches",
  );
  console.log("");
  console.log("Usage:");
  console.log(
  ...
  console.log(
    "  brancher --cherry-pick <hash> -b <branch> [-b <branch> ...] [--push]",
  );
  ...
  console.log(
    "  brancher --cherry-pick abc1234 -b release/5.04 -b release/5.03",
  );
